                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                       <div class="top-box">
                        <ul class="sociel_link">
                         ...
                         <li> <a href="https://www.instagram.com/ezone_2024/" target="_blank"><i class="fa fa-instagram"></i></a></li>
                     ...
                     <div class="limit-box">
                        <nav class="main-menu">
                           <ul class="menu-area-main">
                              ...
                              <li class = "active"> <a href="/refurbished">Refurb</a> </li>
             ...
             <div class="row">
                <div class="col-md-12">
                   <div class="title">
                      ...
                      <span>We package the Refurbished products with best services to make you a happy customer.</span>
                   </div>
                </div>
             </div>
          </div>
