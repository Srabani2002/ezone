          ...
          <div class="row tm-edit-product-row">
            <div class="col-xl-6 col-lg-6 col-md-12">
              <form action="#" action="/addproducts" method="post" class="tm-edit-product-form">
                ...
                <div class="form-group mb-3">
                  <label for="Technician">Technician
                  </label>
                  <input id="Technician" name="Technician" type="text" class="form-control validate" required />
                </div>
                <div class="form-group mb-3">
            ...
            <div class="col-12">
              <button type="submit" class="btn btn-primary btn-block text-uppercase">Add Service Now</button>
            </div>
            </form>
          </div>
        </div>
