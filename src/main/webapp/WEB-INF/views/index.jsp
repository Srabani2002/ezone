         ...
         <div id="main_slider" class="carousel slide banner-main" data-ride="carousel">
            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  ...
                  <div class="container">
                     <div class="carousel-caption relative">
                        <h1>Welcome <br> <strong class="black_bold">To Our</strong><br>
               ...
               <div class="carousel-item">
                  ...
                  <div class="container">
                     <div class="carousel-caption relative">
                        <h1>Our <br> <strong class="black_bold">Offered </strong><br>
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="container">
              <div class="carousel-caption text-bg">
               <div class="img_bg">
                  <i><img src="https://cdn.pixabay.com/photo/2019/12/04/07/51/girl-4671970_640.jpg"/><span>Srabani Bharadwaj<br><strong class="date">12/02/2023</strong></span></i>
          ...
          <div class="carousel-item">
            <div class="container">
              <div class="carousel-caption text-bg">
                <div class="img_bg">
                  <i><img src="https://cdn.pixabay.com/photo/2019/12/04/07/51/girl-4671970_640.jpg"/><span>Harapriya Rath<br><strong class="date">19/02/2023</strong></span></i>
          ...
          <div class="carousel-item">
            <div class="container">
              <div class="carousel-caption text-bg">
                 <div class="img_bg">
                  <i><img src="https://cdn.pixabay.com/photo/2019/12/04/07/51/girl-4671970_640.jpg"/><span>Atasi Panda<br><strong class="date">22/04/2019</strong></span></i>
          ...
          <div class="carousel-item">
            <div class="container">
              <div class="carousel-caption text-bg">
                <div class="img_bg">
                  <i><img src="https://cdn.pixabay.com/photo/2023/06/16/15/10/ai-man-8068201_1280.jpg"/><span>Rakesh Kumar Panda<br><strong class="date">24/05/2023</strong></span></i>
