...
<body id="reportsPage">
                    ...
                    <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-overflow">
                        ...
                        <div class="tm-notification-items">
                            <div class="media tm-notification-item">
                                <div class="tm-gray-circle"><img src="ad-img/notification-01.jpg" alt="Avatar Image"
                            ...
                            <div class="media tm-notification-item">
                                <div class="tm-gray-circle"><img src="ad-img/notification-02.jpg" alt="Avatar Image"
                                        class="rounded-circle"></div>
                                <div class="media-body">
    ...
    <script src="ad-js/moment.min.js"></script>
    <!-- https://momentjs.com/ -->
    <script src="ad-js/Chart.min.js"></script>
    <!-- http://www.chartjs.org/docs/latest/ -->
    <script src="ad-js/bootstrap.min.js"></script>
    <!-- https://getbootstrap.com/ -->
    <script src="ad-js/tooplate-scripts.js"></script>
    <script>
